...
from AshishX.core.call import Nihal
...
async def init():
    ...
    LOGGER("AshishX").info("Music Bot Started Successfully, Now Gib your girlfriend chumt to @II_ASHISH_GUPTA_IIl")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("AshishX").info("Stopping Music Bot, Bhakk Bhosdike (Gaand Maraa Tu)")
